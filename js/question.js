...
const quiz = [
	...
	},
	{
		...
		options: ['The header tag in HTML is used to define the body content of a document or section.', 'The header tag in HTML is used to define a footer section for a document or section.', 'The header tag in HTML is used to define a header section for a document or section, which typically contains a title, logo, navigation menu, or other important information.'],
		answer: 2
	},
	{
